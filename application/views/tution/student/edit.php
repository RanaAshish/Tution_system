    ...
    <div class="box-inner padding">
        <div class="page-header-default">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Student</span> - Edit Student</h4>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form name="form" ng-submit="editStudent()">
...
<script type="text/javascript">
        ...
        app.controller("tutionCtrl", function ($scope,$filter,$http) {
            ...
            $scope.editStudent = function(){
                ...
                $http({
                    url:"<?php echo base_url()."tution/student/edit_student"; ?>",
                    method:"POST",
                    data :$scope.student,
                }).then(function(data){
                    if(data.status){
